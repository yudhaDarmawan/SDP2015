<div class="container-fluid" style="width: 85%; margin: 0 auto;">
	...
	<div class="row">
		<?php echo form_open('laporan/laporan_usp'); ?>
		<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
			...
			<div class="row">
				...
				<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <div class="checkbox">
                        <label><input type="checkbox" value="true" name="cbBelumLunas">Belum Lunas</input></label>
                    </div>
                    <div class="checkbox">
                        <label><input type="checkbox" value="true" name="cbLunas">Lunas</input></label>
                    </div>
				</div>
			</div>
		</div>
        	...
        	<?php
        		for($a = 0; $a < count($table); $a++){
        			if($table[$a]['tanggal_batas'] >= $tanggalAwal AND $table[$a]['tanggal_batas'] <= $tanggalAkhir AND $tanggalAwal != '' AND $tanggalAkhir != ''){
						...
						echo "<td>"; echo ($table[$a]['status'] == 1 ? 'Belum lunas' : 'Lunas'); echo "</td>";
						echo "</tr>";
					}
				}
        	?>
