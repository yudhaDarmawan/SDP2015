<div class="container-fluid" style="width: 85%; margin: 0 auto;">
	<div class="row">
		<h2> Laporan Dispensasi Beasiswa </h2>
	</div>
	<div class="row">
		<?php echo form_open('laporan/laporan_x'); ?>
		...
		<table width="100%" class="table table-striped table-bordered" id="dtbKurikulum" cellspacing="0">
        	...
        	<?php
        		for($a = 0; $a < count($table); $a++){
					...
					if($isPeriode1 == true){
						echo $isPeriode1;
						echo "<td>"; echo $table[$a]['1stPeriode']; echo "</td>";
					}
					if($isPeriode2 == true){
						echo "<td>"; echo $table[$a]['2ndPeriode']; echo "</td>";
					}
					if($isPeriode3 == true){
						echo "<td>"; echo $table[$a]['3rdPeriode']; echo "</td>";
					}
