...
class Confirmation_model extends CI_Model {
	...
	public function getAllClassByLecturer($lecturer_id, $orders , $yearNow){				
		...
		$this->db->select('k.id as id, mk.id as kode_mk,mk.jumlah_sks as sks, mk.nama as nama_mk, d.nama as nama_dosen, k.hari as hari, k.jam_mulai as jam, r.nama as nama_ruang, k.status_konfirmasi as status_k,d.nip as dosen_nip');
	...
	public function processClassData($result){
		...
		/*
		$this->db->select('k.id as id, mk.id as kode_mk,mk.jumlah_sks as sks, mk.nama as nama_mk, d.nama as nama_dosen, k.hari as hari, k.jam_mulai as jam, r.nama as nama_ruang, k.status_konfirmasi as status_k');
		*/
		...
		if ($result->hari == NULL){
			...
			$class[] = $days[$result->hari]; 
		}
		
		$class[] = $this->getClassTime($result->jam, $result->sks);
